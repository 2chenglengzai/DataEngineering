...
is_fitted = False # check if the isolation forest model has been trained
...
if __name__ == "__main__":
    ...
    sdf = (sdf.apply(high_volume_rule).apply(isolation_forest_rule).apply(combine_anomalies))
